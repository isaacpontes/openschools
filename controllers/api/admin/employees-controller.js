...
module.exports = {
  ...
  findAll: async function (req, res) {
    try {
      const employees = await employeesService.findAll(true, ['originSector', 'currentSector', 'classroom']);
  ...
  save: async function (req, res) {
    ...
    const employee = employeesService.create(name, enrollment, position, role, bond, birthday, cpf, rg, ctps, electorTitle, pis, address, phone, email, situation, admissionDate, formation, complementaryFormation, workload, fundeb, originSector, currentSector, school, classroom, shift, info);
